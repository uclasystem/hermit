 ...
 * work.
 */
void irqentry_exit_to_user_mode_profiling(struct pt_regs *regs,
					  uint64_t pf_breakdown[]);
static inline void irqentry_exit_to_user_mode(struct pt_regs *regs)
{
	return irqentry_exit_to_user_mode_profiling(regs, NULL);
}
 ...
 */
void noinstr irqentry_exit_profiling(struct pt_regs *regs,
				     irqentry_state_t state,
				     uint64_t pf_breakdown[]);
static inline void irqentry_exit(struct pt_regs *regs, irqentry_state_t state)
{
